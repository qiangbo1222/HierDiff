...
cfg = edict({
    'dataset':
    yaml.load(open(join(args.config_path, 'dataset/denoise.yaml')),
            Loader=Loader),
    'model':
    yaml.load(open(join(args.config_path, 'model/edge_denoise.yaml')),
            Loader=Loader),
    'optim':
    yaml.load(open(join(args.config_path, 'optim/adamw.yaml')), Loader=Loader),
    'scheduler':
    yaml.load(open(join(args.config_path, 'scheduler/step_denoise.yaml')),
            Loader=Loader),
    'trainer':
...
tb_logger = TensorBoardLogger(cfg.trainer.default_root_dir, name='debug')
